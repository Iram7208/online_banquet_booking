...
{               ?>
						<div class="col-md-4 banner-address-left">
							<p><i class="fa fa-map-marker" aria-hidden="true"></i>D-204, Dargah Rd, Mumbai-400026, India.</p>
						</div>
						<div class="col-md-4 banner-address-left">
							<p><i class="fa fa-envelope" aria-hidden="true"></i> <a href="https://mail.google.com/">ansariiramm@gmail.com</a></p>
						</div>
						<div class="col-md-4 banner-address-left">
							<p><i class="fa fa-phone" aria-hidden="true"></i> <a href=""> +91 7208797822</a></p>
						</div>
				...
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>We plan from starting of your Wedding to the Finish with the right budget making the day more special with experience.</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left w3-agileits-bottom-right">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>Our expert team will run your special day arrangements so you can enjoy the day as expected.</p>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
