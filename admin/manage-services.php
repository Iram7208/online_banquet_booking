                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Service Name</th>
                                        <th class="d-none d-sm-table-cell">Service Price(Rs.)</th>
...
{               ?>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                         ...
                                         <td class="d-none d-sm-table-cell"><a href="service-update.php?updid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Update ?');"><i class="fa fa-edit fa-edit" aria-hidden="true"></i></a></td>
