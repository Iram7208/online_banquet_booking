			...
			<div class="agile-contact-form">
				<div class="col-md-6 contact-form-left">
					<div class="w3layouts-contact-form-top">
						<h3>Get in touch</h3>
						<p>We proudly served our clients with precision and excellence for over 5 years.Oue banquet hall is the number one choice.Want to get in touch?We'd love to hear from you.Here is how you can reach us...</p>
					</div>
